...
<section className="relative min-h-[760px] overflow-hidden border-b border-white/10 lg:min-h-[820px]">
  ...
  <div className="relative z-10 mx-auto flex min-h-[760px] max-w-7xl flex-col justify-end px-5 pb-8 pt-24 lg:min-h-[820px] lg:px-8 lg:pb-10">
    <div className="max-w-3xl">
      ...
      >
        ...
        <span className="mt-3 block max-w-3xl text-3xl leading-tight sm:text-4xl lg:text-5xl">
          La communauté de
          <span className="text-yellow-300"> volleyball de plage </span>
          de la région.
        </span>
      </motion.h1>
      ...
      >
        Compétition, plaisir et dépassement. Une ligue rassembleuse où chaque
        soirée devient une expérience.
      </motion.p>
    ...
    >
      <div className="rounded-2xl border border-white/15 bg-slate-950/65 p-5 backdrop-blur-xl">
        <div className="flex items-start gap-4">
          <CloudSun className="h-8 w-8 shrink-0 text-yellow-300" />
          <div>
            <p className="text-2xl font-black">Météo</p>
            <p className="mt-1 text-sm text-slate-300">
              Conditions à Saint-Augustin
            </p>
          </div>
        </div>
      </div>

      <div className="rounded-2xl border border-cyan-300/25 bg-slate-950/65 p-5 backdrop-blur-xl">
        <div className="flex items-start gap-4">
          <CheckCircle2 className="h-8 w-8 shrink-0 text-emerald-300" />
          <div>
            <p className="text-xl font-black">Statut des terrains</p>
            <p className="mt-1 text-sm text-slate-300">
      ...
      <div className="rounded-2xl border border-yellow-300/25 bg-slate-950/65 p-5 backdrop-blur-xl">
        <div className="flex items-start gap-4">
          <CalendarDays className="h-8 w-8 shrink-0 text-yellow-300" />
          <div>
            <p className="text-xl font-black">Prochains matchs</p>
            <p className="mt-1 text-sm text-slate-300">
      ...
      <div className="rounded-2xl border border-cyan-300/25 bg-slate-950/65 p-5 backdrop-blur-xl">
        <div className="flex items-start gap-4">
          <UsersRound className="h-8 w-8 shrink-0 text-cyan-300" />
          <div>
            <p className="text-xl font-black">Une vraie communauté</p>
            <p className="mt-1 text-sm text-slate-300">
              Joueurs, bénévoles et partenaires
            </p>
          </div>
        </div>
      </div>
